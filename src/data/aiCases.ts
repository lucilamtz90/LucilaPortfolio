...
export const aiCases: AiCase[] = [
  ...
  },
  {
    ...
    description:
      'A responsive virtual flower atelier to create bouquets and share them with friends for special occasions. Built entirely with Claude Code — no pre-design, full prompting, hand-made assets.',
  ...
  },
  {
    ...
    description:
      "A responsive B2B platform to centralize branding progress and deliverables for clients, with built-in feedback collection and per-client personalization. Built entirely by prompting — a stylesheet generated by Figma's AI agents was handed to Claude Code to build it out.",
